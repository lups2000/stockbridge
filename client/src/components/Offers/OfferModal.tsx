                ...
                <Row>
                    <Col>
                        <Form.Group>
                            ...
                            <Form.Label style={{
                                color: colorMap(props.offer?.status? props.offer?.status : OfferStatus.OPEN),
                                fontWeight: 600
                            }}>{status}</Form.Label>
                        </Form.Group>
                    </Col>
                    ...
                    <Col>
                        ...
                        </Row>
                        {
                            ...
                            <Row style={{
                                ...
                                <Form.Label>Purchase Date: {props.advert?.purchaseDate.toString().substring(0, 10)}</Form.Label>
                            </Row>
                        }
                         {
                    ...
                    <Col>
                        ...
                        <Row>
                            <Form.Group style={{
                                ...
                                }}> Price {props.offer? "" : "(€)"}</Form.Label>
                                {
                                    props.offer? <Form.Label style={{
                                        color: palette.gray,
                                        font: "bold",
                                        fontWeight: 600
                                    }} >{props.offer.price} €</Form.Label>  : <Form.Control style={{
                                        width: "30%",
                                        color: palette.gray
                        ...
                        <Row>
                            <Form.Group style={{
                                ...
                                <Form.Label style={{
                                    width: props.offer ? "60px" : "110px"
                                }}> Quantity {props.offer? "" : "(pcs)"}</Form.Label>
                                {
                                    props.offer? <Form.Label style={{
                                        color: palette.gray,
                                        font: "bold",
                                        fontWeight: 600
                                    }} >{props.offer.quantity} pcs</Form.Label> :

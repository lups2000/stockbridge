        ...
        <Modal show={props.isShowing} onHide={props.onClose} centered size="lg">
            ...
            <Modal.Body>
                ...
                <Row>
                    <Col>
                        <Form.Group>
                            ...
                            <Form.Label style={{
                                color: status == OfferStatus.OPEN ? "gray" : status == OfferStatus.CANCELED ? "yellow" : status == OfferStatus.REJECTED ? "red" : "blue",
                                fontWeight: 600
                            }}>{status}</Form.Label>
                        </Form.Group>
                    </Col>
                ...
                <Row style={{
                    ...
                    <Col>
                        <Row>
                            <Form.Label>Seller: {props.store?.name}</Form.Label>
                            <Form.Label>{Ratings(props.store ? props.store.rating : 0)}</Form.Label>
                        </Row>
                        <Row>
                            <Form.Group style={{
                                display: "flex",
